...
class SceneServices
{
   ...
   public:
     ...
     */
    bool respawnInteractiveObstacles(pedsim_srvs::SpawnInteractiveObstacles::Request& request,
                                     pedsim_srvs::SpawnInteractiveObstacles::Response& response);

    /**
     * @brief Spawn interactive obstacles
     */
    bool spawnInteractiveObstacles(pedsim_srvs::SpawnInteractiveObstacles::Request& request,
                                   pedsim_srvs::SpawnInteractiveObstacles::Response& response);
     ...
     */
    bool respawnPeds(pedsim_srvs::SpawnPeds::Request& request, pedsim_srvs::SpawnPeds::Response& response);

    bool moveAgentClustersInPedsim(pedsim_srvs::MovePeds::Request& request, pedsim_srvs::MovePeds::Response& response);
   ...
   private:
    ...
    // bool respawnModelsInFlatland(std::vector<std::string> old_model_names, std::vector<flatland_msgs::Model>
    // new_models);
