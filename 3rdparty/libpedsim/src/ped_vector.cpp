...
bool Ped::Tvector::isValid() const { return !(std::isnan(x) && std::isnan(y) && std::isnan(z)); }
...
/// \param   factor The scalar value to multiply with.
Ped::Tvector Ped::Tvector::scaled(double factor) const { return Ped::Tvector(factor * x, factor * y, factor * z); }
...
std::string Ped::Tvector::toString() const { return "vector(" + std::to_string(x) + ", " + std::to_string(y) + ")"; }
...
Ped::Tvector Ped::Tvector::leftNormalVector() const { return Ped::Tvector(-y, x); }

Ped::Tvector Ped::Tvector::rightNormalVector() const { return Ped::Tvector(y, -x); }

double Ped::Tvector::polarRadius() const { return length(); }

Ped::Tangle Ped::Tvector::polarAngle() const { return Tangle::fromRadian(atan2(y, x)); }
...
Ped::Tvector Ped::Tvector::operator*(double factor) const { return scaled(factor); }

Ped::Tvector Ped::Tvector::operator/(double divisor) const { return scaled(1 / divisor); }
...
Ped::Tvector operator-(const Ped::Tvector& vectorIn) { return Ped::Tvector(-vectorIn.x, -vectorIn.y, -vectorIn.z); }

Ped::Tvector operator*(double factor, const Ped::Tvector& vector) { return vector.scaled(factor); }
