...
double Ped::Tagent::keepDistanceForceFunction(double distance) { return -10 * (distance - keepDistanceForceDistance); }
...
/// walk to.
Ped::Tvector Ped::Tagent::myForce(Ped::Tvector e) { return Ped::Tvector(0.0, 0.0); }
...
void Ped::Tagent::move(double stepSizeIn)
{
    ...
    a = forceFactorDesired * desiredforce + forceFactorSocial * socialforce + forceFactorObstacle * obstacleforce +
        myforce + keepdistanceforce + forceFactorRobot * robotforce;
    // if (id == 1) {
